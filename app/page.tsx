...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section
        id="tracks"
        className="relative w-full min-h-[1050px] sm:min-h-[950px] md:min-h-[980px] text-slate-900 flex flex-col items-center justify-start z-10 px-4 pt-2 sm:pt-4 pb-48 sm:pb-52 scroll-mt-6"
      >
