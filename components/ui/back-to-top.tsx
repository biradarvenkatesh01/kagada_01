    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className="fixed bottom-5 sm:bottom-7 left-5 sm:left-7 z-50 w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center bg-[#8a1c1c]/90 backdrop-blur-2xl border-2 border-white/80 text-white shadow-2xl shadow-black/60 hover:bg-[#8a1c1c] hover:border-white transition-all duration-300 group select-none cursor-pointer"
