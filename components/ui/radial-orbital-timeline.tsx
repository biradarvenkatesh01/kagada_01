              ...
              >
                ...
                <motion.div
                  ...
                  className={`
                    ...
                    border-2 
                    transition-glass duration-300 transform-gpu
                  `}
                >
                    ...
                    >
                      ...
                      <div className="relative bg-white border-2 border-white shadow-2xl shadow-black/40 rounded-3xl p-5 sm:p-8 text-slate-900 flex flex-col max-h-[78vh] sm:max-h-none overflow-y-auto custom-scrollbar">
                        ...
                        <button
                          ...
                          className="absolute top-4 right-4 z-30 w-8 h-8 rounded-full bg-slate-100 border border-slate-200 text-[#8a1c1c] hover:bg-[#8a1c1c] hover:text-white transition-colors flex items-center justify-center shadow-md"
