            ...
            >
              ...
              >
                <div className="animate-gear-spin flex items-center justify-center transform-gpu will-change-transform bg-transparent">
                  <svg
                    viewBox="0 0 32 32"
                    className="w-16 h-16 sm:w-44 sm:h-44 text-[#E8E5DC] fill-current"
              ...
              >
                  ...
                  className={`
                    ...
                    ${
                      isExpanded
                        ...
                        : isRelated
                        ? "bg-[#E8E5DC] text-[#5A182B] border-[#5A182B]/50 shadow-lg"
                        : "bg-[#E8E5DC] text-[#5A182B] border-[#5A182B]/30 shadow-md shadow-black/50"
                    }
                    border-2 
                ...
                <div
                  className={`
                    ...
                    ${isExpanded ? "text-[#E8E5DC] scale-115" : "text-[#E8E5DC]/95"}
                  `}
                >
                    ...
                    >
                      ...
                      <div className="relative kagada-paper-card border-2 border-white/95 shadow-2xl shadow-black/40 rounded-3xl p-5 sm:p-7 md:p-8 text-slate-900 flex flex-col max-h-[82vh] sm:max-h-none overflow-y-auto custom-scrollbar">
                        ...
                        <button
                          ...
                          className="absolute top-4 right-4 z-30 w-8 h-8 rounded-full bg-[#E8E5DC] border border-[#5A182B]/30 text-[#5A182B] hover:bg-white transition-colors flex items-center justify-center shadow-md cursor-pointer"
