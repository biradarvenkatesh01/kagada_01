...
export default function RadialOrbitalTimeline({
  ...
  // 📱 BALANCED RESPONSIVE ORBIT RADIUS (118px phone < 480px, 165px tablet < 640px, 240px desktop)
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <div
      className="w-full min-h-[500px] sm:min-h-[740px] flex flex-col items-center justify-center bg-transparent overflow-hidden py-2 sm:py-4 select-none"
      ref={containerRef}
      onClick={handleContainerClick}
    >
      <div className="relative w-full max-w-5xl h-[460px] sm:h-[680px] flex items-center justify-center">
        <div
        ...
        >
          ...
          {/* ⚙️ PURE WHITE VECTOR GEAR (gear-svgrepo-com.svg) ROTATING AT CENTER (BALANCED RESPONSIVE SIZE) */}
          <div className="absolute z-20 flex items-center justify-center pointer-events-none">
            ...
            >
              <svg
                viewBox="0 0 32 32"
                className="w-24 h-24 sm:w-44 sm:h-44 text-white fill-current drop-shadow-[0_0_14px_rgba(255,255,255,0.75)]"
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    left: `-${(item.energy * 0.35 + 36 - 36) / 2}px`,
                    top: `-${(item.energy * 0.35 + 36 - 36) / 2}px`,
                  }}
                />

                {/* 🔴 CIRCULAR NODE BUTTON WITH SVG ICON (BALANCED SIZE FOR PHONES) */}
                <motion.div
                ...
                {/* Node Label Title Below Button (Balanced two-line wrapping on mobile) */}
                <div
                  className={`
