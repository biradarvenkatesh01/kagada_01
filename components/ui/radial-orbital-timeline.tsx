...
export default function RadialOrbitalTimeline({
  ...
  // 📱 TIGHT MOBILE ORBIT RADIUS (95px on phone < 480px, 135px tablet < 640px, 210px desktop)
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <div
      className="w-full min-h-[460px] sm:min-h-[740px] flex flex-col items-center justify-center bg-transparent overflow-hidden py-2 sm:py-4 select-none"
      ref={containerRef}
      onClick={handleContainerClick}
    >
      <div className="relative w-full max-w-5xl h-[420px] sm:h-[680px] flex items-center justify-center">
        <div
        ...
        >
          ...
          {/* ⚙️ PURE WHITE VECTOR GEAR (gear-svgrepo-com.svg) ROTATING AT CENTER (RESPONSIVE SIZE FOR PHONES) */}
          <div className="absolute z-20 flex items-center justify-center pointer-events-none">
            ...
            >
              <svg
                viewBox="0 0 32 32"
                className="w-16 h-16 sm:w-40 sm:h-40 text-white fill-current drop-shadow-[0_0_16px_rgba(255,255,255,0.75)]"
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Node Label Title Below Button (Responsive positioning & sizing for phones) */}
                <div
                  className={`
                    absolute top-10 sm:top-14 left-1/2 -translate-x-1/2 whitespace-nowrap
                    font-roboto-mono text-[11px] sm:text-base font-extrabold tracking-wide
                ...
                <AnimatePresence>
                  {isExpanded && (
                    <motion.div
                      ...
                      className="absolute top-16 sm:top-24 left-1/2 -translate-x-1/2 w-[88vw] max-w-[340px] sm:w-[480px] md:w-[560px] z-[250] pointer-events-auto transform-gpu will-change-transform"
                    >
