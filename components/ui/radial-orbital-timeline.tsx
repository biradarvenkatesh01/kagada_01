    ...
    >
      <div className="relative w-full max-w-5xl h-[400px] sm:h-[660px] flex items-center justify-center">
        ...
        >
          ...
          {/* ⚙️ PURE WHITE VECTOR GEAR (gear-svgrepo-com.svg) - REDUCED MOBILE GEAR SIZE (w-16 h-16) */}
          <div className="absolute z-20 flex items-center justify-center pointer-events-none">
            ...
            >
              <svg
                viewBox="0 0 32 32"
                className="w-16 h-16 sm:w-44 sm:h-44 text-white fill-current drop-shadow-[0_0_14px_rgba(255,255,255,0.75)]"
