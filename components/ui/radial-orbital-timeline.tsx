...
export default function RadialOrbitalTimeline({
  ...
  // 📱 DYNAMIC RESPONSIVE ORBIT RADIUS (135px on phone < 480px, 175px tablet < 640px, 240px desktop)
  useEffect(() => {
    const handleResize = () => {
        ...
        >
          ...
          <div className="absolute z-20 flex items-center justify-center pointer-events-none">
            ...
            >
              <svg
                viewBox="0 0 32 32"
                className="w-20 h-20 sm:w-44 sm:h-44 text-white fill-current drop-shadow-[0_0_16px_rgba(255,255,255,0.75)]"
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Node Label Title Below Button (Responsive sizing for phones) */}
                <div
                  className={`
