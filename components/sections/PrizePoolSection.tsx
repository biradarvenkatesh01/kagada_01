  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-xl md:max-w-2xl mx-auto flex flex-col items-center justify-center text-center">
        {/* Section Heading */}
        <ScrollReveal as="h2" y={15} duration={0.4} className="font-saman text-4xl sm:text-6xl md:text-7xl text-white tshadow-lg mb-6 sm:mb-8 tracking-tight text-center select-none">
        ...
        <div className="w-full flex flex-col items-center gap-5 sm:gap-6">
          ...
          >
            ...
            <h3 className="font-smooch text-3xl sm:text-4xl md:text-5xl font-semibold text-white tracking-wide text-center leading-none mb-1.5 sm:mb-2 tshadow-md">
              Total Prize Money
            </h3>
            ...
            <p className="font-jakarta text-xs sm:text-sm text-white/95 leading-relaxed font-medium max-w-lg mx-auto tshadow-sm">
          ...
          <ScrollReveal
            ...
            delay={80}
            duration={0.45}
            className="relative w-full max-w-lg mx-auto bg-white/40 backdrop-blur-lg border-2 border-white/80 shadow-xl shadow-black/20 rounded-2xl sm:rounded-3xl py-3 px-5 sm:py-3.5 sm:px-6 text-white flex items-center justify-center gap-2.5 sm:gap-3 text-center overflow-hidden"
          >
            <Award className="w-4 h-4 sm:w-5 sm:h-5 text-white shrink-0 drop-shadow-sm" />
            <p className="font-jakarta text-xs sm:text-sm text-white font-semibold leading-snug tshadow-sm">
