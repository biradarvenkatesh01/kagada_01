...
export const TracksSection = memo(function TracksSection() {
  return (
    <section
      id="tracks"
      className="relative w-full min-h-[620px] sm:min-h-[860px] md:min-h-[920px] text-slate-900 flex flex-col items-center justify-start z-40 px-4 pt-2 sm:pt-4 pb-20 sm:pb-28 scroll-mt-6"
    >
